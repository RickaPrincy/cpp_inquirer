...
create_lib_release(){
    ...
    local RELEASE_NAME=cpp_inquirer@0.0.1
    ...
    cp -r ../build/cmake "${RELEASE_NAME}/lib/cmake/cpp_inquirer"
    cp -r ../include/cpp_inquirer "${RELEASE_NAME}/include/cpp_inquirer"
...
git add --all
git commit -m "release: cpp_inquirer@0.0.1"
git tag -a v0.0.1 -m "cpp_inquirer v0.0.1"
